...
<!doctype html>
<% request.setAttribute("aa",request.getAttribute("aa"));%>
<html lang="en"><head>
    <meta charset="utf-8">
...
<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="/memberdata"><span class="fa fa-caret-right"></span> 商品信息</a></li>
            <li class="active"><a href="/memberdata"><span class="fa fa-caret-right"></span>会员信息</a></li>
            <li ><a href="/memberdata"><span class="fa fa-caret-right"></span> User Profile</a></li>
            <li ><a href="/memberdata"><span class="fa fa-caret-right"></span> Media</a></li>
            <li ><a href="/memberdata"><span class="fa fa-caret-right"></span> Calendar</a></li>
        </ul></li>
        ...
        <li data-popover="true"
            ...
            <a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse">
                <i class="fa fa-fw fa-fighter-jet"></i> Premium Features<i class="fa fa-collapse"></i></a>
        </li>
        <li>
...
<div class="content">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" style="border:0px;" allowtransparency="true" src="/memberdata/findUserByName?name=user&pageSize=10&pageNum=1" onload="setIframeHeight(this)"></iframe>
</div>
