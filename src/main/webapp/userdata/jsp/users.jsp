...
<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="index.html"><span class="fa fa-caret-right"></span> 商品信息</a></li>
            <li class="active"><a href="users.html"><span class="fa fa-caret-right"></span>会员信息</a></li>
...
<div id="content">
    <jsp:include page="/memberdata/findUserByName?name=user&pageSize=10&pageNum=1"></jsp:include>
</div>
